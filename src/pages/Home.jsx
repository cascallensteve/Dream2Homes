...
const Home = () => {
  ...
  return (
    <div className="min-h-screen scroll-smooth transition-all duration-300 ease-in-out">
      {/* Hero Section */}
      <section
        className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] flex items-center justify-center bg-blue-900"
      >
        <div
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-6 lg:space-y-8 animate-fade-in-left">
                <div className="space-y-3 lg:space-y-4">
                    <h1 className="hero-text text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-blue-400 leading-tight">
                    Dreams2Home
                  </h1>
